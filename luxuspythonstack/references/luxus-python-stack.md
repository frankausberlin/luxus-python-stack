...
The full list of data-science packages is tracked in [`requirements-ds.txt`](requirements-ds.txt). This makes it diffable, updatable, and allows selective installs — instead of a fragile unmaintainable one-liner.
...
mamba create -y -n $ENV_NAME python=$py google-colab
mamba activate $ENV_NAME

# Install packages from the pinned requirements file
uv pip install -r requirements-ds.txt \
    --extra-index-url https://download.pytorch.org/whl/cu126   # adjust for your CUDA version
